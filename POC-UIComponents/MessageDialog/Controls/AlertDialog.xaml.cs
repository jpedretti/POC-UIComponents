...
namespace MessageDialog.Controls
{
    public sealed partial class AlertDialog : ContentDialog
    {
        ...
        private static readonly DependencyProperty MessageProperty =
            DependencyProperty.Register("Message", typeof(string), typeof(AlertDialog), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty Button1TextProperty =
            DependencyProperty.Register("Button1Text", typeof(string), typeof(AlertDialog), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty Button2TextProperty =
            DependencyProperty.Register("Button2Text", typeof(string), typeof(AlertDialog), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty Button1CommandProperty =
            DependencyProperty.Register("Button1Command", typeof(ICommand), typeof(AlertDialog), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty Button2CommandProperty =
            DependencyProperty.Register("Button2Command", typeof(ICommand), typeof(AlertDialog), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty Button1EnabledProperty =
            DependencyProperty.Register("Button1Enabled", typeof(Visibility), typeof(AlertDialog), new PropertyMetadata(Visibility.Collapsed));
        ...
        private static readonly DependencyProperty Button2EnabledProperty =
            DependencyProperty.Register("Button2Enabled", typeof(Visibility), typeof(AlertDialog), new PropertyMetadata(Visibility.Collapsed));
